...
class _QrCodeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    String hoursStr = _timeRemaining.inHours.remainder(24).toString().padLeft(2, '0');
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("Terminal Id - A09909", style: customTextStyle),
                        ],
                      ),
                      Row(
                        children: [
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child:Center(
                          child: Text("$formattedDate  $formattedTime", style: customTextStyle),
                        ),
                      ),
                      ...
                      Container(
                          ...
                          child: Center(
                            child: DateTime.now().hour >= 22 || DateTime.now().hour <=9 ?
                            Text(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Column(
                      children: [
                        Padding(padding: EdgeInsets.fromLTRB(0.0, 5.0, 5.0, 5.0),
                          child: Button_G(
                              text: "ACCOUNT" ,
                              onPressed: () {
